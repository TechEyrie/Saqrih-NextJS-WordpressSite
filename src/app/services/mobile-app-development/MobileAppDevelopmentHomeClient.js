...
import {
  MOBILE_DEV_HOME_HERO,
  MOBILE_DEV_HOME_RTS,
  MOBILE_DEV_HOME_RTS_CARDS,
  MOBILE_DEV_HOME_RTS_INTRO,
  MOBILE_DEV_HOME_OPERATE,
  MOBILE_DEV_HOME_ADVANTAGE,
  MOBILE_DEV_HOME_UNLOCKING,
    ...
    >
      ...
      <main id="main-content" className="homepage-font-scope">
        <HeroSection
          ...
          titleLine1={MOBILE_DEV_HOME_HERO.titleLine1}
          titleLine2={MOBILE_DEV_HOME_HERO.titleLine2}
          showTrademark={MOBILE_DEV_HOME_HERO.showTrademark}
          description={MOBILE_DEV_HOME_HERO.description}
        />
        <LazyWhenVisible minHeight="55vh">
          <RTSSection text={MOBILE_DEV_HOME_RTS} />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="100vh">
          <RTSCombinedSection
            pageKey="homepage"
            cards={MOBILE_DEV_HOME_RTS_CARDS}
            servicesIntro={MOBILE_DEV_HOME_RTS_INTRO}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="70vh">
          <HowWeOperateSection text={MOBILE_DEV_HOME_OPERATE} />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="90vh">
          <ServiceTechStackSection
            categories={MOBILE_HOME_TECH_CATEGORIES}
            stats={MOBILE_HOME_TECH_STATS}
            capabilities={MOBILE_HOME_TECH_CAPABILITIES}
            marquee={MOBILE_HOME_TECH_MARQUEE}
            eyebrow={MOBILE_HOME_TECH_COPY.eyebrow}
            headingLine1={MOBILE_HOME_TECH_COPY.headingLine1}
            headingLine2={MOBILE_HOME_TECH_COPY.headingLine2}
            body={MOBILE_HOME_TECH_COPY.body}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="60vh">
          <OurAdvantageSection
            label={MOBILE_DEV_HOME_ADVANTAGE.label}
            headingLines={MOBILE_DEV_HOME_ADVANTAGE.headingLines}
            paragraphs={MOBILE_DEV_HOME_ADVANTAGE.paragraphs}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="100vh">
        ...
        <LazyWhenVisible minHeight="70vh">
          <UnlockingSection
            heading={
              <>
                {MOBILE_DEV_HOME_UNLOCKING.headingLine1}
                <br />
                {MOBILE_DEV_HOME_UNLOCKING.headingLine2}
              </>
            }

...
import {
  WEB_APP_DEV_HOME_HERO,
  WEB_APP_DEV_HOME_RTS,
  WEB_APP_DEV_HOME_RTS_CARDS,
  WEB_APP_DEV_HOME_RTS_INTRO,
  WEB_APP_DEV_HOME_OPERATE,
  WEB_APP_DEV_HOME_ADVANTAGE,
  WEB_APP_DEV_HOME_UNLOCKING,
  WAD_TECH_CATEGORIES,
  WAD_TECH_STATS,
  WAD_TECH_CAPABILITIES,
  WAD_TECH_MARQUEE,
  WAD_TECH_COPY,
  WEB_APP_DEV_HOME_FAQS,
  WEB_APP_DEV_HOME_FAQ_INTRO,
  WEB_APP_DEV_HOME_FAQ_HEADING,
...
export default function WebApplicationDevelopmentHomeClient() {
    ...
    >
      ...
      <main id="main-content" className="homepage-font-scope">
        <HeroSection
          ...
          titleLine1={WEB_APP_DEV_HOME_HERO.titleLine1}
          titleLine2={WEB_APP_DEV_HOME_HERO.titleLine2}
          showTrademark={WEB_APP_DEV_HOME_HERO.showTrademark}
          description={WEB_APP_DEV_HOME_HERO.description}
        />
        <LazyWhenVisible minHeight="55vh">
          <RTSSection text={WEB_APP_DEV_HOME_RTS} />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="100vh">
          <RTSCombinedSection
            pageKey="homepage"
            cards={WEB_APP_DEV_HOME_RTS_CARDS}
            servicesIntro={WEB_APP_DEV_HOME_RTS_INTRO}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="70vh">
          <HowWeOperateSection text={WEB_APP_DEV_HOME_OPERATE} />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="90vh">
          <ServiceTechStackSection
            categories={WAD_TECH_CATEGORIES}
            stats={WAD_TECH_STATS}
            capabilities={WAD_TECH_CAPABILITIES}
            marquee={WAD_TECH_MARQUEE}
            eyebrow={WAD_TECH_COPY.eyebrow}
            headingLine1={WAD_TECH_COPY.headingLine1}
            headingLine2={WAD_TECH_COPY.headingLine2}
            body={WAD_TECH_COPY.body}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="60vh">
          <OurAdvantageSection
            label={WEB_APP_DEV_HOME_ADVANTAGE.label}
            headingLines={WEB_APP_DEV_HOME_ADVANTAGE.headingLines}
            paragraphs={WEB_APP_DEV_HOME_ADVANTAGE.paragraphs}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="100vh">
        ...
        <LazyWhenVisible minHeight="70vh">
          <UnlockingSection
            heading={
              <>
                {WEB_APP_DEV_HOME_UNLOCKING.headingLine1}
                <br />
                {WEB_APP_DEV_HOME_UNLOCKING.headingLine2}
              </>
            }
            cards={WEB_APP_DEV_HOME_UNLOCKING.cards}
          />
        </LazyWhenVisible>
                <LazyWhenVisible minHeight="70vh">
          <ServiceFAQSection
            faqs={WEB_APP_DEV_HOME_FAQS}
            intro={WEB_APP_DEV_HOME_FAQ_INTRO}
            heading={WEB_APP_DEV_HOME_FAQ_HEADING}
          />
        </LazyWhenVisible>

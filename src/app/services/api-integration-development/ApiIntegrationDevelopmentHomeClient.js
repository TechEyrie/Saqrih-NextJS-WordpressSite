...
import {
  API_DEV_HOME_HERO,
  API_DEV_HOME_RTS,
  API_DEV_HOME_RTS_CARDS,
  API_DEV_HOME_RTS_INTRO,
  API_DEV_HOME_OPERATE,
  API_DEV_HOME_ADVANTAGE,
  API_DEV_HOME_UNLOCKING,
  ...
  API_HOME_TECH_COPY,
  API_DEV_HOME_FAQS,
  API_DEV_HOME_FAQ_INTRO,
  API_DEV_HOME_FAQ_HEADING,
...
export default function ApiIntegrationDevelopmentHomeClient() {
    ...
    >
      ...
      <main id="main-content" className="homepage-font-scope">
        <HeroSection
          ...
          titleLine1={API_DEV_HOME_HERO.titleLine1}
          titleLine2={API_DEV_HOME_HERO.titleLine2}
          showTrademark={API_DEV_HOME_HERO.showTrademark}
          description={API_DEV_HOME_HERO.description}
        />
        <LazyWhenVisible minHeight="55vh">
          <RTSSection text={API_DEV_HOME_RTS} />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="100vh">
          <RTSCombinedSection
            pageKey="homepage"
            cards={API_DEV_HOME_RTS_CARDS}
            servicesIntro={API_DEV_HOME_RTS_INTRO}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="70vh">
          <HowWeOperateSection text={API_DEV_HOME_OPERATE} />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="90vh">
          <ServiceTechStackSection
            categories={API_HOME_TECH_CATEGORIES}
            stats={API_HOME_TECH_STATS}
            capabilities={API_HOME_TECH_CAPABILITIES}
            marquee={API_HOME_TECH_MARQUEE}
            eyebrow={API_HOME_TECH_COPY.eyebrow}
            headingLine1={API_HOME_TECH_COPY.headingLine1}
            headingLine2={API_HOME_TECH_COPY.headingLine2}
            body={API_HOME_TECH_COPY.body}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="60vh">
          <OurAdvantageSection
            label={API_DEV_HOME_ADVANTAGE.label}
            headingLines={API_DEV_HOME_ADVANTAGE.headingLines}
            paragraphs={API_DEV_HOME_ADVANTAGE.paragraphs}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="100vh">
        ...
        <LazyWhenVisible minHeight="70vh">
          <UnlockingSection
            heading={
              <>
                {API_DEV_HOME_UNLOCKING.headingLine1}
                <br />
                {API_DEV_HOME_UNLOCKING.headingLine2}
              </>
            }
            cards={API_DEV_HOME_UNLOCKING.cards}
          />
        </LazyWhenVisible>
                <LazyWhenVisible minHeight="70vh">
          <ServiceFAQSection
            faqs={API_DEV_HOME_FAQS}
            intro={API_DEV_HOME_FAQ_INTRO}
            heading={API_DEV_HOME_FAQ_HEADING}
          />
        </LazyWhenVisible>

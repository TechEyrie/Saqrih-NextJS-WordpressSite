...
import {
  WSM_DEV_HOME_HERO,
  WSM_DEV_HOME_RTS,
  WSM_DEV_HOME_RTS_CARDS,
  WSM_DEV_HOME_RTS_INTRO,
  WSM_DEV_HOME_OPERATE,
  WSM_DEV_HOME_ADVANTAGE,
  WSM_DEV_HOME_UNLOCKING,
  ...
  WSM_HOME_TECH_COPY,
  WSM_DEV_HOME_FAQS,
  WSM_DEV_HOME_FAQ_INTRO,
  WSM_DEV_HOME_FAQ_HEADING,
...
export default function WebsiteSupportMaintenanceHomeClient() {
    ...
    >
      ...
      <main id="main-content" className="homepage-font-scope">
        <HeroSection
          ...
          titleLine1={WSM_DEV_HOME_HERO.titleLine1}
          titleLine2={WSM_DEV_HOME_HERO.titleLine2}
          showTrademark={WSM_DEV_HOME_HERO.showTrademark}
          description={WSM_DEV_HOME_HERO.description}
        />
        <LazyWhenVisible minHeight="55vh">
          <RTSSection text={WSM_DEV_HOME_RTS} />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="100vh">
          <RTSCombinedSection
            pageKey="homepage"
            cards={WSM_DEV_HOME_RTS_CARDS}
            servicesIntro={WSM_DEV_HOME_RTS_INTRO}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="70vh">
          <HowWeOperateSection text={WSM_DEV_HOME_OPERATE} />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="90vh">
          <ServiceTechStackSection
            categories={WSM_HOME_TECH_CATEGORIES}
            stats={WSM_HOME_TECH_STATS}
            capabilities={WSM_HOME_TECH_CAPABILITIES}
            marquee={WSM_HOME_TECH_MARQUEE}
            eyebrow={WSM_HOME_TECH_COPY.eyebrow}
            headingLine1={WSM_HOME_TECH_COPY.headingLine1}
            headingLine2={WSM_HOME_TECH_COPY.headingLine2}
            body={WSM_HOME_TECH_COPY.body}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="60vh">
          <OurAdvantageSection
            label={WSM_DEV_HOME_ADVANTAGE.label}
            headingLines={WSM_DEV_HOME_ADVANTAGE.headingLines}
            paragraphs={WSM_DEV_HOME_ADVANTAGE.paragraphs}
          />
        </LazyWhenVisible>
        <LazyWhenVisible minHeight="100vh">
        ...
        <LazyWhenVisible minHeight="70vh">
          <UnlockingSection
            heading={
              <>
                {WSM_DEV_HOME_UNLOCKING.headingLine1}
                <br />
                {WSM_DEV_HOME_UNLOCKING.headingLine2}
              </>
            }
            cards={WSM_DEV_HOME_UNLOCKING.cards}
          />
        </LazyWhenVisible>
                <LazyWhenVisible minHeight="70vh">
          <ServiceFAQSection
            faqs={WSM_DEV_HOME_FAQS}
            intro={WSM_DEV_HOME_FAQ_INTRO}
            heading={WSM_DEV_HOME_FAQ_HEADING}
          />
        </LazyWhenVisible>

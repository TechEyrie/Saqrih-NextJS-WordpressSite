...
export const metadata = buildPageMetadata({
  title: "Sell Your WordPress Agency",
  description: "Saqrih acquires WordPress businesses and design agencies—get a fair valuation.",
  path: "/wordpress/sell-my-design-company",
});
...
export default function Layout({ children }) {
  return (
    <>
      <JsonLd
        data={[
          breadcrumbJsonLd([{"name":"Home","url":"/"},{"name":"WordPress","url":"/wordpress"},{"name":"Sell Your WordPress Agency","url":"/wordpress/sell-my-design-company"}]),
          serviceJsonLd({
            name: "Sell Your WordPress Agency",
            description: "Saqrih acquires WordPress businesses and design agencies—get a fair valuation.",
            url: "/wordpress/sell-my-design-company",

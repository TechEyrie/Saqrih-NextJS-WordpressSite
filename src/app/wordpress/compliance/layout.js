...
export const metadata = buildPageMetadata({
  title: "WordPress Compliance Services",
  description: "Compliance-focused WordPress development and audits from Saqrih.",
  path: "/wordpress/compliance",
});
...
export default function Layout({ children }) {
  return (
    <>
      <JsonLd
        data={[
          breadcrumbJsonLd([{"name":"Home","url":"/"},{"name":"WordPress","url":"/wordpress"},{"name":"WordPress Compliance Services","url":"/wordpress/compliance"}]),
          serviceJsonLd({
            name: "WordPress Compliance Services",
            description: "Compliance-focused WordPress development and audits from Saqrih.",
            url: "/wordpress/compliance",

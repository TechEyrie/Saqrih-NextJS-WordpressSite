...
export const metadata = buildPageMetadata({
  ...
  description: "Reliable WordPress support for fixes, updates, and day-to-day site management.",
...
export default function Layout({ children }) {
  return (
    <>
      <JsonLd
        data={[
          breadcrumbJsonLd([{"name":"Home","url":"/"},{"name":"WordPress","url":"/wordpress"},{"name":"WordPress Support Services","url":"/wordpress/support"}]),
          serviceJsonLd({
            name: "WordPress Support Services",
            description: "Reliable WordPress support for fixes, updates, and day-to-day site management.",
            url: "/wordpress/support",

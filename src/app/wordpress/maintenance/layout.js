...
export const metadata = buildPageMetadata({
  ...
  description: "WordPress maintenance plans covering updates, monitoring, fixes, and proactive care from Saqrih.",
...
export default function Layout({ children }) {
  return (
    <>
      <JsonLd
        data={[
          breadcrumbJsonLd([{"name":"Home","url":"/"},{"name":"WordPress","url":"/wordpress"},{"name":"WordPress Website Maintenance","url":"/wordpress/maintenance"}]),
          serviceJsonLd({

...
export const metadata = buildPageMetadata({
  ...
  description: "Safe WordPress migrations with minimal downtime and SEO preservation.",
...
export default function Layout({ children }) {
  return (
    <>
      <JsonLd
        data={[
          breadcrumbJsonLd([{"name":"Home","url":"/"},{"name":"WordPress","url":"/wordpress"},{"name":"WordPress Migration Services","url":"/wordpress/migration"}]),
          serviceJsonLd({
            name: "WordPress Migration Services",
            description: "Safe WordPress migrations with minimal downtime and SEO preservation.",
            url: "/wordpress/migration",

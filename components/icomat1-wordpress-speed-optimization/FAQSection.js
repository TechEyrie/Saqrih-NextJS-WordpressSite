...
const FAQS = getServiceFaqs("speed-optimization").map((faq, index) => ({
  id: index + 1,
  ...faq,
}));
...
const INTRO_PARAS = [
  ...
  "A detailed audit helps us identify what is working well and what is slowing your site down. Once we understand your setup, we apply targeted WordPress speed optimization techniques to improve overall performance efficiently.",
];
...
export default function FAQSection() {
  ...
  // Header entrance
  useEffect(() => {
    const targets = [headingRef.current, subtitleRef.current].filter(Boolean);
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            WordPress Speed Up Service: A Complete Audit and Website Performance Optimization
          </h2>

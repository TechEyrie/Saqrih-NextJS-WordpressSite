      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Since 2019 Freshy and the Tiger team have partnered to fully
      ...
      >
        ...
        >
          ...
          >
            <MetaColumn
              label="Industry"
              items={["Energy", "Environmental", "Retail"]}
            />
            <MetaColumn
              label="Services"
              items={[
            ...
            <MetaColumn
              label="Timeline"
              items={["6-month average from project onset to launch", "Ongoing support"]}
            />
          </div>
        </div>
      </div>

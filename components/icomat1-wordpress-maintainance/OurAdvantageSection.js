    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-[45%_10%_45%] items-start">
        <div className="flex flex-col gap-4 md:gap-6">
          ...
          >
            Choose Saqrih's professional WordPress maintenance plans to enhance performance, strengthen security, and maintain long-term reliability for your website.
          </p>

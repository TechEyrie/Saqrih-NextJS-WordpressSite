...
const FAQS = getServiceFaqs("marketing-pro").map((faq, index) => ({
  id: index + 1,
  ...faq,
}));
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Practical answers about web accessibility, ADA alignment on WordPress, plugins, testing, certification
            expectations, and WCAG conformance levels.
          </p>
        </div>

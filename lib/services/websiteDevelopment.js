/**
 * Website Design — main service + sub-services.
 * Edit this file to add/rename sub-services; routes update automatically.
 * Route slug remains `/services/website-development`.
 */
...
export const WEBSITE_DEVELOPMENT = {
  ...
  heroTitleLines: ["Website", "design"],
  heroLead:
    "Our in-house team of skilled designers and developers builds fast, conversion-focused websites tailored to your brand and business goals.",
  description:
    "Custom website design from Saqrih—design, build, and launch high-performance sites for businesses in Qatar and beyond.",
  serviceType: "Website design",
};

/** Sub-services nested under Website Design */

...
const GROUP_META = {
  ...
  payments: {
    ...
    blurb:
      "Checkout and subscription rails: cards, wallets, and recurring revenue.",
    usedFor: "Stores, SaaS billing, mobile purchases",
    icon: "layers",
  },
  shipping: {
    id: "shipping",
...
export const HOMEPAGE_TECH_STATS = [
  ...
  { value: "8", label: "Service stacks combined" },
];

export const HOMEPAGE_TECH_CAPABILITIES = [
  {
    title: "Full-stack coverage",
    desc: "Web, commerce, mobile, SaaS, CMS, APIs, and ongoing care in one toolkit.",
    icon: "layers",
  },
  {
...
export const HOMEPAGE_TECH_COPY = {
  ...
  body: "A combined toolkit from our website, web app, SaaS, e-commerce, mobile, CMS, API, and maintenance practices, chosen to ship products that last.",
};

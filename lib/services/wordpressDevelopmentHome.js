...
export const WORDPRESS_DEV_HOME_HERO = {
  ...
  showTrademark: false,
  description:
    "As a premier WordPress development agency in Qatar, Saqrih delivers fast, scalable, and SEO-ready websites engineered for performance and growth.",
};

export const WORDPRESS_DEV_HOME_FAQ_HEADING =
  "WordPress Development Agency Qatar";

export const WORDPRESS_DEV_HOME_FAQ_INTRO =
  "Questions about custom themes, SEO, migrations, and hiring WordPress developers in Qatar.";

export const WORDPRESS_DEV_HOME_FAQS = [
  {
    question: "Can you build custom WordPress themes and plugins?",
    answer:
      "Yes, we specialize in developing bespoke WordPress themes from scratch and custom plugins designed to meet unique functional requirements.",
  },
  {
    question: "Are your WordPress websites mobile-friendly and optimized for SEO?",
    answer:
      "Yes. Every WordPress website project we deliver is built with a responsive, mobile-first design and adheres to rigorous SEO best practices.",
  },
  {
    question: "Can you redesign or migrate my existing website to WordPress?",
    answer:
      "Yes, our team handles seamless website migrations from platforms like Wix, Squarespace, or custom legacy systems to WordPress, ensuring zero data loss, preserved SEO rankings, and a modernized user interface.",
  },
  {
    question: "What makes Saqrih the best WordPress development agency in Qatar?",
    answer:
      "At Saqrih, we go beyond standard templates. As a leading WordPress development agency in Qatar, our experienced wordpress developers in Qatar build custom, secure, lightning-fast, and SEO-optimized websites tailored specifically to your business goals.",
  },
  {
    question: "How do I hire a professional WordPress developer in Qatar?",
    answer:
      "Contact us to share your project requirements and we will evaluate your requirements and recommend a tailored plan that fits your business needs.",
  },
];

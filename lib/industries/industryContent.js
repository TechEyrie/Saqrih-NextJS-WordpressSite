...
function buildIndustryContent(slug, name) {
  ...
  return {
    ...
    metadata: {
      title: `${name} Website Design Qatar | WordPress Experts | Saqrih`,
      description: `Professional ${lower} web design and WordPress development in Qatar. Saqrih builds fast, SEO-ready ${lower} websites with hosting, maintenance, and ongoing support.`,
      keywords: seoKeywords(name),
      openGraph: {
        title: `${name} Website Design Qatar | Saqrih`,
        description: `Custom WordPress websites for ${lower} businesses in Qatar—design, development, hosting, SEO, and support from Saqrih.`,
        type: "website",
      },
    },
    hero: {
    ...
    seoResults: {
      ...
      intro1: `From kickoff to launch, Saqrih pairs each ${name} WordPress project with an experienced project manager and senior website designer—so your site stays on strategy, on schedule, and built to convert.`,

 ...
 * Hero backgrounds: homepage_bg_video1 (homepage + /wordpress/* heroes); services-hero (blog, markets, etc.).
...
export const HOMEPAGE_HERO_BACKGROUND_VIDEO =
  "/videos/homepage_bg_video1.mp4";

/** /wordpress/* service page heroes */
export const WORDPRESS_HERO_BACKGROUND_VIDEO = HOMEPAGE_HERO_BACKGROUND_VIDEO;

...
/** @param {number} n — 1-based slot (wraps to 1…11) */
export function usefulVideo(n) {
  const slot = ((Math.floor(n) - 1) % USEFUL_VIDEO_MAX + USEFUL_VIDEO_MAX) % USEFUL_VIDEO_MAX;
...
export const USEFUL_VIDEO_8 = usefulVideo(8);

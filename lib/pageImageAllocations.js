...
export const PAGE_IMAGE_SLOTS = {
  ...
  home1: (() => {
    ...
    // Hero + RTS panel only — swapped off eyrion-1 / eyrion-8
    b.endToEnd[5] = b.hero;
    b.hero = 28;
    b.endToEnd[0] = b.rtsCombinedPanel;
    b.rtsCombinedPanel = 23;
    return b;
  })(),
  "wp-premium-support1": buildBundle(14, {
    hero: 1,
    customerBackground: 1,
    customerModal: 1,
    unlocking: 2,

...
export const PAGE_IMAGE_SLOTS = {
  ...
  "case-study-pathfinders": { endToEnd: consecutiveSlots(16, 8), showcase: [36, 37] },
  "case-study-earthscape": { endToEnd: consecutiveSlots(17, 8), showcase: [32, 33] },
  "case-study-d-and-d-financial": { endToEnd: consecutiveSlots(18, 8), showcase: [34, 35] },
  "case-study-infinitystore": { endToEnd: consecutiveSlots(19, 8), showcase: [36, 37] },
  "case-study-premieronesolutions": { endToEnd: consecutiveSlots(20, 8), showcase: [32, 33] },
  "case-study-cash-boys": { endToEnd: consecutiveSlots(21, 8), showcase: [34, 35] },
  "case-study-sleepy-sloth-society": { endToEnd: consecutiveSlots(22, 8), showcase: [36, 37] },
  "case-study-bay-clinic-of-chiropractic": { endToEnd: consecutiveSlots(23, 8), showcase: [32, 33] },
  "case-study-amazed-home-care": { endToEnd: consecutiveSlots(24, 8), showcase: [34, 35] },
  "case-study-expedition-labs": { endToEnd: consecutiveSlots(25, 8), showcase: [36, 37] },
  "case-study-kala-holdings": { endToEnd: consecutiveSlots(26, 8), showcase: [32, 33] },

...
/** Contact page — LocalBusiness contact node linked to Organization. */
export function contactPageJsonLd() {
  return {
    ...
    name: "Contact Saqrih",
    description:
      "Contact Saqrih in Doha, Qatar for website development, web apps, SaaS, e-commerce, mobile apps, WordPress, CMS, APIs, and ongoing support.",
    isPartOf: { "@id": `${SITE_ORIGIN}/#website` },
    about: { "@id": `${SITE_ORIGIN}/#organization` },
    mainEntity: {
      "@type": "Organization",
      ...
      telephone: "+97459929039",
      address: {
        "@type": "PostalAddress",
        streetAddress: "No 16, Al Meena St",
        addressLocality: "Doha",
        addressCountry: "QA",
      },
    },
